...
"""
import sys
sys.setrecursionlimit(1000000)  # 将递归深度限制设置为 1500
import asyncio
import base64
import gzip
import hmac
...
appid = "5474869740"    # 项目的 appid
token = "y7DiW5JCWTiKRLWiGN6wOdHbOll9PSk9"    # 项目的 token
cluster = "volcengine_input_common"  # 请求的集群
audio_path = "D:/wav/output.wav"  # 本地音频路径
